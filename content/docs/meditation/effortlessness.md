...
You will need to be familiar with [IFS terminology](https://estrelacounseling.com/docs/ifs/).
...
You can bring this list to your [IFS Practitioner](https://estrelacounseling.com/docs/ifs/)
