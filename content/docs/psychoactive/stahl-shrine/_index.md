...
What follows is **not** a historical reconstruction (the ancients had neither coffee grinders nor 95% ethanol). It's Stahl's proposed adaptation for the modern era. Treat it as a strong hypothesis awaiting archaeological proof. Kykeon is similar in effect to mescaline. <span class="psych-scale" data-pattern="🛶1️⃣❤️🍃">
...
<div class="rite-variant-toggle">
  <button type="button" class="rite-variant-btn" data-rite-variant="none">Don't Need Help</button>
  <button type="button" class="rite-variant-btn" data-rite-variant="uninspired">Uninspired</button>
...
<div class="rite-timeline">
  ...
  <div class="rite-stop" data-rite-stop="uninspired-lunch">
...
<div class="rite-timeline">
  ...
  <div class="rite-stop" data-rite-stop="thai-lunch">
    <span class="rite-icon">☀️</span>
    <span class="rite-time">T-0, midday</span>
    <span class="rite-title">Lunch</span>
  </div>
